...
xst -ifn xst.scr
move Clock_Regulator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock_Regulator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock_Regulator_exdes.ucf Clock_Regulator_exdes

echo 'Running map'
map -timing -pr b Clock_Regulator_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm Clock_Regulator_exdes -w routed.ncd routed.vhd
cd ..
